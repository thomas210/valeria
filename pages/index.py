...
def app():
    ...
    st.write("Aqui, o nosso objetivo é auxiliar os profissionais de saúde para ter mais confiança no diagnóstico inicial dos pacientes. Espero que possamos trabalhar bem juntos!")
    ...
    st.write("Caso possua alguma dúvida a respeito de alguma funcionalidade, acesse a barra de menu no canto esquerdo e escolha a opção **Ajuda**.")
