...
def app():
    ...
    st.write("Esperamos que essas informações ajudem os médicos a entender o porquê do modelo ter feito a classificação final, e, junto com a experiência do próprio profissional de saúde, poder oferecer um diagnóstico clínico mais acurado.")
